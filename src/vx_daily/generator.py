...
def generate_draft(profile: dict, topics: dict, target_date: date_type, attempt: int = 1) -> ArticleDraft:
    topic = select_topic(topics, target_date)
    target_date_text = target_date.isoformat()
    persona = "、".join(profile["persona"])
    ...
    sections = [
        ...
        Section(
            heading="最后",
            paragraphs=[
                f"我一直相信，技术文章可以严谨，也可以有温度。作为一个{persona}的人，我更愿意把复杂问题讲得朴素一点。",
